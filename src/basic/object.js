(function (globals) {
  ...
  (function () {
    ...
    Object.staticMethod('sortByValues', function (obj) {
      ...
      var ordered = {};
      var keysSorted = Object.keys(obj)
        .sort(function (a, b) {
          return obj[a] - obj[b];
        })
        .forEach(function (key) {
    ...
    Object.staticMethod('deepCopy', function (obj) {
      ...
      if (obj instanceof Array) {
        ...
        result = {};
        for (var prop in obj)
          if (prop != gdcc) result[prop] = arguments.callee(obj[prop]);
          else if (set) result[prop] = arguments.callee(cache);
      }
      if (set) {
        obj[gdcc] = cache;
      } else {
    ...
    Object.staticMethod('deepExtend', function (destination, source) {
      if (!globals.toolset.isObject(source)) {
        throw {
          name: 'ValueError',
    ...
    Object.staticMethod('hashCode', function (value) {
      if (globals.toolset.isNull(value)) {
        throw {
          name: 'ValueError',
