(function (globals) {
  ...
  (function () {
    ...
    Object.prototype.property = (function () {
      const desc_ = { enumerable: false, configurable: false, writable: true };

      return function (name, value, desc) {
        if (!this) return this;

        if (globals.toolset.isFunction(value)) {
          throw globals.exception.typeException(
            'TypeError',
            `incorrect input argument: {value} is not a function < ${value} >`
          );
        }
        ...
        globals.utils.logger.Logger.debug(
          `property < ${name} > is added to < ${this.name == '' ? this.constructor.name : this.name} >`
        );
        return this;
        //}
      };
    ...
    Object.prototype.method = (function () {
      const desc_ = { enumerable: false, configurable: false };
      ...
      return function (name, func, desc) {
        ...
        if (!globals.toolset.isFunction(func)) {
          throw globals.exception.typeException(
            'TypeError',
            `incorrect input argument: {func} is not a function < ${func} >`
          );
        }

        const old = this.prototype[name];
        this.prototype[name] = function () {
          if (func.length === arguments.length) {
            ...
            throw globals.exception.valueException(
              'ValueError',
              `incorrect signature: invalid function contract for < ${name} >`
            );
          }
        };
        desc = globals.toolset.isObject(desc) ? desc : desc_;
        Object.defineProperty(this.prototype, name, desc);
        globals.utils.logger.Logger.debug(
          `method < ${name} > is added to < ${this.name == '' ? this.constructor.name : this.name} >`
        );
        return this;
    ...
    Object.prototype.staticProperty = (function () {
      ...
      return function (name, value, desc) {
        ...
        globals.utils.logger.Logger.debug(
          `static property < ${name} > is added to < ${this.name == '' ? this.constructor.name : this.name} >`
        );
        return this;
        //}
      };
    ...
    Object.prototype.staticMethod = (function () {
      ...
      return function (name, func, desc) {
        ...
        Object.defineProperty(this, name, desc);
        globals.utils.logger.Logger.debug(
          `static method < ${name} > is added to < ${this.name == '' ? this.constructor.name : this.name} >`
        );
        return this;
