(function (globals) {
  ...
  (function () {
    ...
    //----------------------------------------------------------------------------------------------
    const SuffixTree = (function () {
      var suffixTreeNode = (function () {
        return function (cmp) {
          let children = null;
          const indexes = globals.toolset.vector();
          //var that = {};
          const that = Object.create(suffixTreeNode);
      ...
      return function (spec, cmp) {
        const root = suffixTreeNode(cmp);
        //var that = {};
        const that = Object.create(globals.collections.tree.SuffixTree);
